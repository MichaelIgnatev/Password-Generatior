...
def save_password():
    with open("Ваш пароль.txt", "w") as f:
        f.write(f'Ваш пароль - {answer}\n')
...
save_bt = Button(win, text='Сохранить в файл...', font=('Times new roman', 12),
                 command=save_password, justify=CENTER, borderwidth=4, width=14)
save_bt.grid(row=7, column=0, sticky='e', padx=10, columnspan=2)
